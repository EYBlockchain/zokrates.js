 ...
 * @param {String} outputName - Name of Solidity file (with or without trailing .sol)
 * @param {String} provingScheme - Available options are G16, PGHR13, GM17
 */
async function exportVerifier(codePath, outputPath, outputName = 'verifier.sol', provingScheme) {
